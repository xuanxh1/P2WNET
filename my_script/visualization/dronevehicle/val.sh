...
save_path=./test_out/p2wnet_grauate_desgin/dronevehicle/best
model=data/output/models/p2wnet/standard_version/drone_vehicle/runtime/512_640_192_224/innerdis0_pred144_numf_256_dmodel256_prednum_256_attnlayer2/bs8_fp32/best.pt
...
python test_folder/icme_statistic_visualization.py \
  ...
  --num_of_task_token=4 \
  --training_search_img_size 512 640 \
  --training_template_img_size 192 224 \
  --cnn_activation "gelu" \
  --att_activation "gelu" \
  --kernel_fn "elu" \

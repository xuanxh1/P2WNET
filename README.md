...
P2WNet focuses on solving homography estimation problems in **Part-to-Whole** and **Cross-Modality** scenarios
...
The constructed dataset Landsat-cross can be downloaded from Hugging Face:
...
Pre-trained model weightsare available for download:
